...
async def run_live_verification():
    async with async_playwright() as p:
        ...
        print("\n--- 1. Navigating to BHOOMI ---")
        await page.goto("http://127.0.0.1:3055/login", wait_until="networkidle")

        # Perform Reviewer Demo Login to enter dashboard
        print("Logging in via Reviewer Demo Login...")
        await page.click("button:has-text('Reviewer Demo Login')")
        await page.wait_for_selector("#dashboardView", state="visible", timeout=10000)
        ...
        print(">>> SUCCESS: Voice Assistant in English has ZERO Telugu characters.")

        await page.screenshot(path="voice_modal_english.png")
        ...
        print(">>> SUCCESS: Voice Assistant immediately updated to Telugu while open.")

        await page.screenshot(path="voice_modal_telugu.png")
        ...
        assert "End Call" in en2_end_call
        ...
        print(">>> SUCCESS: Voice Assistant immediately reverted back to English.")
        ...
        print(">>> SUCCESS: Voice Assistant immediately updated to Hindi.")

        await page.screenshot(path="voice_modal_hindi.png")

        # Verify recognizer language mapping
        ...
        print("Closed voice modal successfully.")

        await browser.close()
        print("\n==========================================")
        print("ALL LIVE BROWSER LOCALIZATION TESTS PASSED!")
        print("==========================================")
