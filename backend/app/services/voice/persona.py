...
class BhoomiPersonaEngine:
    ...
    def format_vision_diagnosis(
        ...
        if safety_blocked:
            if lang == "te":
                return f"{greeting} అన్నా, దయచేసి జాగ్రత్తగా ఉండండి. ఆ రసాయన మందు వాడటం నిషేధించబడినది (నిషిద్ధం) మరియు మీ పంటకు, ఆరోగ్యానికి ప్రమాదకరం. దానిని పిచికారీ చేయవద్దు. సురక్షితమైన జీవ నియంత్రణ మందును మాత్రమే వాడండి."
            elif lang == "hi":
