...
class TestRecommendationTraceStoreBatch10:
    ...
    def test_31_migration_chain_integrity(self):
        ...
        assert ("001_rec_traces" in heads_output or "002_task_lifecycle" in heads_output or "003_task_events" in heads_output or "004_scheduler_state" in heads_output or "005_farmer_notifications" in heads_output)
